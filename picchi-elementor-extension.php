 ...
 * Author:      Saiful Kader
 * Author URI:  #
 * Text Domain: picchi-elementor-extension
 ...
 * @since 1.0.0
 */
final class picchi_elementor_extension {
	...
	public function i18n() {
		...
		load_plugin_textdomain( 'picchi-elementor-extension', FALSE, basename( dirname( __FILE__ ) ) . '/languages/' );
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" to be installed and activated.', 'picchi-elementor-extension' ),
			'<strong>' . esc_html__( 'Picchi Elementor  Extension', 'picchi-elementor-extension' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'picchi-elementor-extension' ) . '</strong>'
		);
	...
	public function admin_notice_minimum_elementor_version() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'picchi-elementor-extension' ),
			'<strong>' . esc_html__( 'Picchi Elementor  Extension', 'picchi-elementor-extension' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'picchi-elementor-extension' ) . '</strong>',
	...
	public function admin_notice_minimum_php_version() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'picchi-elementor-extension' ),
			'<strong>' . esc_html__( 'Picchi Elementor  Extension', 'picchi-elementor-extension' ) . '</strong>',
			'<strong>' . esc_html__( 'PHP', 'picchi-elementor-extension' ) . '</strong>',
	...
	public function widget_scripts() {
		wp_register_script( 'picchi-elementor-extension-js', plugins_url( 'main.js', __FILE__ ) );
		wp_enqueue_script('picchi-elementor-extension-js');
	}
...
picchi_elementor_extension::instance();